...
- [x] Fix the co-located healthy downstream simulator at one CPU and 256 MiB in the shared Compose definition so it cannot inherit the larger treatment host's additional capacity.
